...
class TeamGameStat(Base):
    ...
    total_yards: Mapped[Optional[int]] = mapped_column(Integer)
    ...
    turnovers_forced: Mapped[Optional[int]] = mapped_column(Integer)
    turnovers_lost: Mapped[Optional[int]] = mapped_column(Integer)
    third_down_pct: Mapped[Optional[float]] = mapped_column(Float)
    redzone_pct: Mapped[Optional[float]] = mapped_column(Float)
