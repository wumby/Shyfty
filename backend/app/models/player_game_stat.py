...
class PlayerGameStat(Base):
    ...
    passing_completions: Mapped[Optional[int]] = mapped_column(Integer)
    passing_attempts: Mapped[Optional[int]] = mapped_column(Integer)
    interceptions: Mapped[Optional[int]] = mapped_column(Integer)
    rushing_yards: Mapped[Optional[int]] = mapped_column(Integer)
    rushing_attempts: Mapped[Optional[int]] = mapped_column(Integer)
    ...
    sacks: Mapped[Optional[int]] = mapped_column(Integer)
